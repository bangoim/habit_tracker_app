      ...
      child: Padding(
        ...
        child: Stack(
          children: [
            ...
            // Botão de check e PopupMenuButton
            Positioned(
              top: 1,
              right: 1,
              child: Material(
            ...
            Positioned(
              ...
              child: PopupMenuButton<String>(
                icon: Icon(
                  Icons.more_vert,
                  color: Theme.of(context).colorScheme.onSurfaceVariant
                      .withOpacity(0.7), // Cor do ícone do menu
                  size: 26,
                ),
                ...
                onSelected: (value) async {
                  if (value == 'edit') {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) => HabitFormScreen(habit: widget.habit),
                      ),
                    ).then((result) {
                      if (result == true) {
                        widget.onHabitModified();
                      }
                    });
                  } else if (value == 'delete') {
                    _deleteHabit(widget.habit.id);
                  } else if (value == 'view_heatmap') {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder:
